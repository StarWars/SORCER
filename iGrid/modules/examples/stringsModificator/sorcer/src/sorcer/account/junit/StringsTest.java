...
import sorcer.account.provider.Strings;
...
public class StringsTest implements SorcerConstants {

	private final static Logger logger = Logger
			.getLogger(StringsTest.class.getName());
	...
	static {
		...
		Sorcer.setCodeBase(new String[] { "jeri-strings-dl.jar" });
	...
	public void accout1BalanceTest() throws Exception {
		Task t1 = task("t1",
				sig("getBalance", ServiceStrings.class, "Strings1"),
	...
	public void accout1DepositTest() throws Exception {
		Task t2 = task("t2",
				sig("makeDeposit", ServiceStrings.class, "Strings1"),
	...
	public void accout2BalanceTest() throws Exception {
		Task t3 = task("t3",
				sig("getBalance", ServiceStrings.class, "Strings2"),
	...
	public void accout2WithdrawalTest() throws Exception {
		Task t4 = task("t4",
				sig("makeWithdrawal", ServiceStrings.class, "Strings2"),
	...
	public void parmetricBalanceTest() throws Exception {
		Task balance = task(
				"balance",
				sig("getBalance", Strings.class, "Strings1"),
					result("balance/amount"));

		logger.info("Strings1 balance: " + value(balance));
	}
	...
	public void parmetricDepositTest() throws Exception {
		Task deposit = task(
				"deposit",
				sig("makeDeposit", Strings.class, "Strings1"),
