...
public class ServiceStringsImpl implements Strings, ServiceStrings, SorcerConstants {
	...
	public ServiceStringsImpl(Money startingBalance) throws RemoteException {
